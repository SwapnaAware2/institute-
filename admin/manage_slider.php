                ...
                <tbody>
                  <tr>
                   <td><input type="checkbox" class="checkAll">
                    ...
                    <td><a href="edit_slider.php?id=<?php echo $id; ?>"><button class="btn btn-primary" style="width:60px;"> Edit <!-- <i class="fa fa-edit" style="color:green" title="Edit"></i> --></button></a>&nbsp;

...
?>
	  ...
	  <main class="app-content">
        <div class="app-title">
        <div>
          <h1 style="margin-top:10px;"><i class="fa fa-users"></i>Manage Product </h1>
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-xs-12 col-sm-12">
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              <form class="row" action="add_technology.php" method="POST" enctype="multipart/form-data">
	    ...
	    <div class="box box-danger">
			...
			<div class="horizontal">
              <table class="table table-hover table-bordered" id="sampleTable">
				...
				$sql="SELECT * FROM manage_product";
                ...
                <tbody>
                  <tr>
                   <td><input type="checkbox" class="checkAll">
                     ...
                     <td><a href="edit_technology.php?id=<?php echo $id; ?>"><button class="btn btn-primary" style="width:60px;"> Edit <!--<i class="fa fa-edit" style="color:green" title="Edit"></i>--></button></a>&nbsp;
                  <a href="delete_technology.php?id=<?php echo $id; ?>"><button button class="btn btn-danger" style="width:60px;padding-left:7px;"> Delete<!--<i class="fa fa-trash" style="color:red" title="Delete"></i>--></button></a></button>
